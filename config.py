...
def initConfig():
	...
	setCell("vk_bot_vk_id", '0') # Сюды ид беседы в vk
	...
	setCell( "app_id", 0 ) # Приложение, у которого есть доступ взаимодействовать с ВК
	...
	setCell( "vk_1", '-904601663' ) # Пример переадресации ЛС ВК в Telegram
	setCell( "t_-904601663", '1' ) # Пример переадресации ЛС ВК в Telegram
